...
class TransferLearningModel(tf.Module):
    ...
    """
        with tf.GradientTape() as tape:
            ...
            prediction_0 = tf.math.multiply(reversed_action, prediction)  # action 값만 0인 prediction [3.5, 0, 4, 5]
            prediction_next_0 = tf.math.multiply(action, prediction_next)  # action 값만 x인 prediction [0. x, 0, 0]
